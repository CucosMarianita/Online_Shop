        ...
        public static void Initialize(IServiceProvider serviceProvider)
        {
                ...
                <DbContextOptions<ApplicationDbContext>>()))
            {
                ...
                context.Roles.AddRange(
                    ...
                    new IdentityRole { Id = "2c5e174e-3b0e-446f-86af-483d56fd7211", Name = "Colab", NormalizedName = "Colab".ToUpper() },
                ...
                context.Users.AddRange(
                    ...
                    new ApplicationUser
                    {
                        ...
                        EmailConfirmed = true,
                        NormalizedEmail = "COLAB@TEST.COM",
                        Email = "colab@test.com",
                        NormalizedUserName = "COLAB@TEST.COM",
                        PasswordHash = hasher.HashPassword(null, "Colab#1")
                    },
                    new ApplicationUser
                    {
